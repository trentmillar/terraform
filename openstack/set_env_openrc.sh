...
export OS_TENANT_ID=be7f89ff1e7b436c91e9826c70e079ad
...
echo "Please enter your OpenStack Email/Username: "
read -r OS_EMAIL_INPUT
export OS_USERNAME=$OS_EMAIL_INPUT
export OS_TENANT_NAME=$OS_EMAIL_INPUT
